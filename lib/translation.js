...
const en = {
  ...
  tk_preview: 'Preview',
  tk_support_text:
    "The project right now doesn't have any monetization. Help us to continue to build and grow a great educational and information crypto portal.",
  tk_source: 'Source:'
}
...
const ind = {
  ...
  tk_support_text:
    'Project saat ini tidak memiliki monetisasi apa pun. Bantu kami untuk terus membangun dan mengembangkan portal kripto pendidikan dan informasi yang hebat.'
}
